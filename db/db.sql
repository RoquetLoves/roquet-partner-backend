create schema partner collate utf8mb4_general_ci;
...
INSERT INTO partner.team (id, teamName, teamAvatarUrl, teamPassword, teamDesc, maxNum, expireTime, userId, usersId,
                              createTime, teamStatus, isDelete, announce, updateTime)
VALUES (100001, '加密测试队', 'https://bdimg6.qunliao.info/fastdfs7/M00/21/15/rBUC6GVq-W-Af1u_AAsNKF93umo405.png', '6c7bf8e3df13c49a2a11bdcfe9a81f2e', '超级无敌霸气', 5,
        '2023-10-1 19:53:57', 10001, '[10001]', '2023-03-10 23:59:12', 2, 0, '当你对自己诚实的时候，世界上就没有人能够欺骗得了你。',
        '2023-03-23 18:56:23');
INSERT INTO partner.team (id, teamName, teamAvatarUrl, teamPassword, teamDesc, maxNum, expireTime, userId, usersId,
                              createTime, teamStatus, isDelete, announce, updateTime)
VALUES (100002, '公开测试队', 'https://img.lku.icu/typory/22.jfif', '6c7bf8e3df13c49a2a11bdcfe9a81f2e', '超级无敌霸气', 5,
...
INSERT INTO partner.user (id, username, userAccount, userAvatarUrl, gender, userPassword, contactInfo, userDesc,
                              userStatus, userRole, tags, teamIds, userIds, createTime, updateTime, isDelete, email)
VALUES (10001, '罗凯', 'luokai', 'https://bdimg6.qunliao.info/fastdfs7/M00/21/15/rBUC6GVq-W-Af1u_AAsNKF93umo405.png', 1,
        '89c7f39d98fb169ffea0698c18831fe1', 'vx:lk1774541152', '阿巴阿巴', 0, 1,
        '["C#","Java","C++","找伙伴","女","求职中","男","运动","Python","音乐","上班族"]', '[100002,100001]', '[2,3,4]',
        '2023-03-08 23:46:31', '2023-03-11 00:42:35', 0, '1415225036@qq.com');
...
ALTER DATABASE roquet CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;